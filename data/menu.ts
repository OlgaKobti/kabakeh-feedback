...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    price: 65,
    image: "moajanat.jpg",
    name: { en: "Moajanat (4 pastries)", he: "מואג׳נאת (4 מאפים)", ar: "معجنات (4 سمبوسك)" },
    description: { en: "4 assorted pastries", he: "4 מאפים מגוונים", ar: "4 معجنات متنوعة" },
  },
  {
    id: "homemade_hummus",
    category: "starters",
  ...
  },
  {
    ...
    price: 46,
    image: null,
    name: { en: "Fried cauliflower with tahini", he: "כרובית מטוגנת עם טחינה", ar: "قرنبيط مقلي مع طحينة" },
    description: { en: "", he: "", ar: "" },
  },
  {
    id: "jibneh",
    ...
    description: { en: "Fried Arabic cheese", he: "גבינה ערבית מטוגנת", ar: "جبنة عربية مقلية" },
  },
  {
    id: "baba_ghanouj",
    category: "starters",
    ...
    name: { en: "Baba ghanouj", he: "בבא גנוש", ar: "بابا غنوج" },
    description: { en: "", he: "", ar: "" },
  },
  {
    id: "french_fries",
  ...
  /* ---------------- From our kitchen ---------------- */
  {
    ...
    description: { en: "Ask the waiters", he: "שאלו את המלצרים", ar: "اسألوا النُدُل" },
  },
  {
    id: "mujadara",
    category: "from_our_kitchen",
    price: 48,
    image: "Mjaddarah.jpg",
    name: { en: "Mujadara", he: "מוג׳דרה", ar: "مجدّرة" },
    description: { en: "", he: "", ar: "" },
  },
  {
    id: "mlokhia",
