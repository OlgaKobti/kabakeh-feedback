    ...
    <AdminShell active="dashboard">
      ...
      >
        ...
        <a href="/admin/events" style={{ textDecoration: "none" }}>
          ...
          >
            <div style={{ width: 48, height: 48, background: "#fdf4ff", borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 16 }}>
              🗓️
            </div>
            <div style={{ fontSize: 20, fontWeight: 700, color: "#111", marginBottom: 6 }}>Events</div>
            <div style={{ color: "#6b7280", fontSize: 14, marginBottom: 20 }}>
              Add and publish upcoming events on the website
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ background: "#fdf4ff", color: "#7c3aed", padding: "4px 12px", borderRadius: 20, fontSize: 13, fontWeight: 600 }}>
                {eventCount} events
              </div>
              <span style={{ color: "#9ca3af", fontSize: 20 }}>→</span>
            </div>
